...
public class LineChart_compare_exp_imp extends JFrame {

    public LineChart_compare_exp_imp(String applicationTitle , String chartTitle , String code1,String code2, int start , int end, char ch,ArrayList<country> c) {
